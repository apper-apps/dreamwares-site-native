...
const HeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="pt-32 pb-20 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      <Container>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4 mb-10">
              {valuePops.map((prop, index) => (
                <div key={index} className="flex items-center text-lg">
                  <div className="w-8 h-8 bg-accent/10 rounded-full flex items-center justify-center mr-4">
                    <ApperIcon name={prop.icon} className="w-4 h-4 text-accent" />
                  </div>
                  <span className="text-dark font-medium">{prop.text}</span>
                </div>
              ))}
            </div>
          ...
          <div className="animate-on-scroll stagger-2">
            <div className="relative">
              <div className="hero-gradient rounded-2xl p-8 text-white shadow-2xl">
